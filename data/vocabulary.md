...
- **DNA** — The single portable file (cortex.md) that defines the entire Cortex system. Carrying this one file to any project and running genesis births a new Cortex instance. README.md lives in the GitHub repo as a landing page but is not part of the portable DNA.
